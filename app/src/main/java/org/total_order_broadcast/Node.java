...
public abstract class Node extends AbstractActor {
  ...
  final static int ELECTION_TIMEOUT = 8000; // timeout for the election, ms
    ...
    /**
     * Message class used to send a write operation request with a value.
     */
    public static class WriteDataMsg implements Serializable {
        ...
        /**
         * Constructs a WriteDataMsg with the specified value, sender, and an undeferrable flag.
         *
         * @param value The integer value to write.
         * @param sender The actor reference of the message sender.
         * @param shouldFlush Boolean flag indicating whether the message should be deferred during election.
         */
         ...
         * Defaults the shouldFlush flag to false.
         *
         * @param value The integer value to write.
         * @param sender The actor reference of the message sender.
         */
